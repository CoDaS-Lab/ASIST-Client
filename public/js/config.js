...
"pages": [{"name": "page1",
      "elements": [{"type": "radiogroup",
                    ...
                    {"type": "radiogroup",
                    "name": "q2",
                    "title": "What does the agent know?",
                    "isRequired":true,
                    "choices": [{"value": "item1", "text": "The agent knows where the victim is."},
                                {"value": "2", "text": "The agent has access to the same information as the player."},
                                {"value": "item3", "text": "The agent knows what parts of the map are dangerous for the player."},
                                {"value": "item4", "text": "There is no agent in this game."}],
                    "choicesOrder":"random"},
                    {"type": "radiogroup",
                    "name": "q3",
